...
public class FlutterUdidPlugin: NSObject, FlutterPlugin {
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "getUDID":
            ...
            let bundleName = args?["bundleName"] as? String
            self.getUniqueDeviceIdentifierAsString(initBundleName: bundleName, result: result);
        default:
            result(FlutterMethodNotImplemented)
        }
    }
    
    private func getUniqueDeviceIdentifierAsString(initBundleName: String?, result: FlutterResult) {
        let bundleName = initBundleName ?? Bundle.main.infoDictionary!["CFBundleName"] as! String
